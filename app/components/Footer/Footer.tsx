...
const socialLinks: socialLinks[] = [
    {
        ...
        link: 'https://www.facebook.com/Rafamusicbox',
        width: 10
    },
    {
        imgSrc: '/assets/footer/insta.svg',
        link: 'https://www.instagram.com/rafael_santos2024/',
        width: 14
    },
    {
        imgSrc: '/assets/footer/twitter.svg',
        link: 'https://x.com/RafaelMusicbox',
        width: 14
    },
    ...
    return (
        ...
        <div className="mx-auto max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-gray-blue'>
                <h4 className='text-dark-red opacity-75 text-sm text-center md:text-start font-normal'>@2024.Rafael Lee.All rights reserved</h4>
